...
const styles: any = {
  card: { background: '#fff', borderRadius: '12px', padding: '32px', boxShadow: 'var(--shadow-md)', border: '1px solid #e2e8f0' },
  ...
  button: { display: 'inline-flex', alignItems: 'center', padding: '10px 20px', background: 'var(--primary)', color: '#fff', border: 'none', borderRadius: '6px', fontWeight: 600, cursor: 'pointer', transition: 'opacity 0.2s' },
